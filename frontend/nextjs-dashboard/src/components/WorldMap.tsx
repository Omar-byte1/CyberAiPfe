...
export default function WorldMap({ data }: WorldMapProps) {
  ...
  return (
    <div className="w-full h-[400px] sm:h-[500px] relative rounded-2xl overflow-hidden bg-gray-50 bg-white/50 border border-slate-100">
      {data.length === 0 ? (
        ...
        <>
          ...
          <Tooltip
            ...
            className="z-50 font-bold !bg-white/95 !text-gray-900 !rounded-xl !px-4 !py-3 !text-sm shadow-sm border border-gray-200/50"
          />

          {/* Legend */}
          <div className="absolute bottom-4 left-4 bg-white/90 p-3 rounded-xl shadow-sm border border-gray-200/50 text-xs font-bold text-slate-600 flex flex-col gap-2">
